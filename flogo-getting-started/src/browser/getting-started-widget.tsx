...
export class GettingStartedWidget extends ReactWidget {
    ...
    protected readonly documentationUrl = 'https://github.com/clint-ide/clint-ide';
    ...
    protected renderFlogo(): React.ReactNode {
        return <div className='gs-section'>
            ...
            <div className='gs-action-container'>
                <a href={this.documentationUrl} target='_blank'>Create a new Flogo project</a>
            </div>
        </div>;
    }
